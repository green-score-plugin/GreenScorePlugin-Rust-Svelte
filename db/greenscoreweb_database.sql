...
(2, 'data.equivalent.paris_londres', 0.67, 'train-paris-londres.png'),
(3, 'data.equivalent.emails', 847.45, 'email.png'),
(4, 'data.equivalent.search', 813, 'search.png'),
(5, 'data.equivalent.streaming', 33.3, 'youtube.png'),
(6, 'data.equivalent.bus', 25, 'bus.png'),
(7, 'data.equivalent.motorbike', 4.54, 'motorbike.png'),
(8, 'data.equivalent.car', 4.54, 'car.png'),
(9, 'data.equivalent.tap_water', 7692.30, 'faucet.png'),
(10, 'data.equivalent.paris_ny', 0.0009, 'new-york.png');
